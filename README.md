...
- предложение нового места пользователем (адрес или координаты) с постмодерацией;
- режим случайного выбора **«🎲 Кубик»**;
- cookie-согласие при первом визите;
- админ-панель: модерация, справочники городов/категорий, feature flags — вход скрыт, без системы аккаунтов (см. ADR-005).

Полный список функциональных и нефункциональных требований — [`docs/02_PRD.md`](docs/02_PRD.md). Визуальное направление интерфейса, провалидированное прототипом, — [`docs/13_UI_UX_Design.md`](docs/13_UI_UX_Design.md).
...
2. ⏳ Проектирование — Domain Model ✅, UI/UX-концепт ✅, ER-диаграмма, Database Design, API Design (OpenAPI), C4-архитектура.
